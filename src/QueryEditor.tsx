...
export class QueryEditor extends PureComponent<Props> {
  ...
  getApplicationMetrics = async () => {
    console.info('[QueryEditor.getApplicationMetrics]');
    const { query, datasource, onChange } = this.props;
    ...
    if (applicationMetrics.length !== (query.applicationMetrics?.length || 0)) {
      console.info('applicationMetrics changed');
      onChange({
        ...query,
  ...
  getAlertColumns = async () => {
    console.info('[QueryEditor.getAlertColumns]');
    const { query, datasource, onChange } = this.props;
  ...
  getMetrics = async () => {
    console.info('[QueryEditor.getMetrics]');
  ...
  getOptions = (sourceGroup: SourceGroup) => {
    console.info(`[QueryEditor.getOptions] ${sourceGroup}`);
  ...
  onSourceGroupChange = (v: any) => {
    console.info(`[QueryEditor.onSourceGroupChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.sourceGroup) {
      console.info('sourceGroup changed');
  ...
  onHostGroupChange = (v: any) => {
    console.info(`[QueryEditor.onHostGroupChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentHostGroup?.value) {
      console.info('currentHostGroup changed');
      onChange({
        ...query,
        currentHostGroup: v,
      });
  ...
  onApplicationChange = (v: any) => {
    console.info(`[QueryEditor.onApplicationChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentApplication?.value) {
      console.info('currentApplication changed');
      onChange({
        ...query,
  ...
  onWebAppChange = (v: any) => {
    console.info(`[QueryEditor.onWebAppChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentWebApp?.value) {
      console.info('currentWebApp changed');
      onChange({
        ...query,
        currentWebApp: v,
      });
  ...
  onIPChange = (e: any) => {
    console.info(`[QueryEditor.onIPChange] ${e.target.value}`);
    console.info(e);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onApplicationMetricChange = (v: any) => {
    console.info(`[QueryEditor.onApplicationMetricChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentApplicationMetric?.value) {
      console.info('[QueryEditor.onApplicationMetricChange] currentApplicationMetric changed');
      onChange({
        ...query,
  ...
  onHostGroupMetricChange = (v: any) => {
    console.info(`[QueryEditor.onHostGroupMetricChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentHostGroupMetric?.value) {
      console.info('[QueryEditor.onHostGroupMetricChange] currentHostGroupMetric changed.');
      onChange({
        ...query,
  ...
  onWebAppMetricChange = (v: any) => {
    console.info(`[QueryEditor.onWebAppMetricChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentWebAppMetric?.value) {
      console.info('[QueryEditor.onWebAppMetricChange] currentWebAppMetric changed.');
      onChange({
        ...query,
  ...
  onIPMetricChange = (v: any) => {
    console.info(`[QueryEditor.onIPMetricChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentIPMetric?.value) {
      console.info('[QueryEditor.onIPMetricChange] currentIPMetric changed.');
      onChange({
        ...query,
        currentIPMetric: v
      });
  ...
  onExpirationTimeChange = (e: any) => {
    console.info(`[QueryEditor.onExpirationTimeChange] ${e.target.value}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onTopMetricChange = (v: any) => {
    console.info(`[QueryEditor.onTopMetricChange] ${v.label}, ${v.value}`);
    const { onChange, query, onRunQuery } = this.props;
    if (v.value !== query.currentTopMetric?.value) {
      console.info('[QueryEditor.onTopMetricChange] currentTopMetric changed.');
      onChange({
        ...query,
        currentTopMetric: v
      });
  ...
  onTopChange = (e: any) => {
    console.info(`[QueryEditor.onTopChange] ${e.currentTarget.checked}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onTopGraphChange = (e: any) => {
    console.info(`[QueryEditor.onTopGraphChange] ${e.currentTarget.checked}`);
    const { onChange, query, onRunQuery } = this.props;
  ...
  onTopNChange = (e: any) => {
    console.info(`[QueryEditor.onTopNChange] ${e.currentTarget.value}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onAliasChange = (v: any) => {
    console.info(`[QueryEditor.onAliasChange] ${v.target.value}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onTimeshiftChange = (v: any) => {
    console.info(`[QueryEditor.onTimeshiftChange] ${v.target.value}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onGranularityChange = (v: any) => {
    console.info(`[QueryEditor.onGranularityChange] ${JSON.stringify(v)}`);
  ...
  onSSLColumnsChange = (v: any) => {
    console.info("[QueryEditor.onSSLColumnsChange]");
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onAlertsColumnsChange = (v: any) => {
    console.info("[QueryEditor.onAlertsColumnsChange]");
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  onAlertLimitChange = (e: any) => {
    console.info(`[QueryEditor.onAlertLimitChange] ${e.target.value}`);
    const { onChange, query, onRunQuery } = this.props;
    onChange({
      ...query,
  ...
  render() {
    console.info('[QueryEditor.render]');
