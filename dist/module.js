...
var ConfigEditor = /*#__PURE__*/function (_PureComponent) {
  ...
  _createClass(ConfigEditor, [{
    ...
    value: function render() {
      ...
      var Input = _grafana_ui__WEBPACK_IMPORTED_MODULE_0__["LegacyForms"].Input,
          SecretFormField = _grafana_ui__WEBPACK_IMPORTED_MODULE_0__["LegacyForms"].SecretFormField;
      var secureJsonData = options.secureJsonData || {};
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        className: "gf-form-inline"
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
        className: "gf-form"
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["InlineFormLabel"], {
        className: "width-10"
        ...
        className: "gf-form"
      }, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["InlineFieldRow"], null, react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_0__["InlineField"], {
  ...
  _createClass(QueryEditor, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
        ...
        style: query.sourceGroup === _types__WEBPACK_IMPORTED_MODULE_4__["SourceGroup"].alerts ? {
          display: 'block'
        } : {
          display: 'none'
        }
        ...
        label: "Limit",
        tooltip: "Max. number of alert to get"
      }, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_3__["Input"], {
            ...
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                promises = options.targets.map(function (target) {
                  ...
                  if (query.sourceGroup == _types__WEBPACK_IMPORTED_MODULE_4__["SourceGroup"].alerts) {
                    console.log("Current Alerts Columns: ".concat(query.currentAlertsColumns.map(function (c) {
                      return c.value;
                    })));
                    return _this2.getAlerts(query.currentAlertsColumns, start, end, granularity === null || granularity === void 0 ? void 0 : granularity.value, query.alertLimit).then(function (items) {
                      var frame;
                      var fields = [];

                      for (var index = 0; index < query.currentAlertsColumns.length; index++) {
                        fields.push({
                  ...
                  } else if (query.sourceGroup == _types__WEBPACK_IMPORTED_MODULE_4__["SourceGroup"].ssl) {
                      ...
                      for (var i = 0; i < items.length; i++) {
                        ...
                        if (item["valid_from"] >= new Date(start * 1000) && item["valid_to"] <= new Date(end * 1000)) {
                          ...
                          if (query.expirationTime > -1) {
                            ...
                            for (var _index3 = 0; _index3 < fields.length; _index3++) {
                              row.push(item[fields[_index3].value]);
                            }
                    ...
                    if (query.topGraph) {
                      return _this2.topngraphquery(query, start, end, 0).then(function (data) {
                        ...
                        for (var i = 0; i < dataDef.data.length; i++) {
                          ...
                          for (var _index4 = 0; _index4 < tops.length; _index4++) {
                            if (tops[_index4] === datum[2]) {
